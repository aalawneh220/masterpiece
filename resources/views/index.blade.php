  ...
  @section('content')
      ...
      <section class="hero-section">
          ...
          <div class="card-grid">
              ...
              <a class="card" href="#">
                  <div class="card__background"
                      style="background-image: url(https://images.pexels.com/photos/6131162/pexels-photo-6131162.jpeg?cs=srgb&dl=pexels-tima-miroshnichenko-6131162.jpg&fm=jpg&_gl=1*13quer6*_ga*MjAzMTc2NDA5Ny4xNjY0NTU2MTI1*_ga_8JE65Q40S6*MTY2ODMyMjEwOS4yMS4xLjE2NjgzMjIzMzIuMC4wLjA.)">
                  </div>
                  <div class="card__content">
                      <p class="card__category">Category</p>
          ...
          <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">
                  <div class="price_table_container">
                      ...
                      <a href="./donate/1" class="btn btn-danger btn-lg btn-block">Subsecribe</a>
                  </div>
              </div>
              ...
              <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">
                  <div class="price_table_container">
                      ...
                      <a href="./donate/2" class="btn btn-royal btn-lg btn-block">Subsecribe</a>
                  </div>
              </div>
              ...
              <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">
                  ...
                  <div class="price_table_container">
                      ...
                      <div class="price_table_body">
                          <div class="price_table_row cost static-bg" value="15" name="amount"><strong>$
                                  60</strong><span>/MONTH</span></div>
                          <div class="price_table_row">Washing your pet</div>
                          <div class="price_table_row">trim nails your pet</div>
                          <div class="price_table_row">cutting pet hair</div>
                          <div class="price_table_row">vaccine your animal</div>
                      ...
                      <a href="./donate/3" class="btn btn-static btn-lg btn-block">Subsecribe</a>
                  </div>
              </div>
          </div>
      </div>
